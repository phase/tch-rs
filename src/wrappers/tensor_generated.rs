...
impl Tensor {
    ...
    pub fn internal_fused_sgd<T: Borrow<Tensor>>(
        out: &[T], self_: &[T], grads: &[T], momentum_buffer_list: &[T], weight_decay: f64, momentum: f64, lr: f64, dampening: f64, nesterov: bool, maximize: bool, is_first_step: bool, grad_scale: Option<T>, found_inf: Option<T>
    ) {
        Tensor::f_internal_fused_sgd(out, self_, grads, momentum_buffer_list, weight_decay, momentum, lr, dampening, nesterov, maximize, is_first_step, grad_scale, found_inf).unwrap()
    }

    pub fn internal_fused_sgd_<T: Borrow<Tensor>>(
        self_: &[T], grads: &[T], momentum_buffer_list: &[T], weight_decay: f64, momentum: f64, lr: f64, dampening: f64, nesterov: bool, maximize: bool, is_first_step: bool, grad_scale: Option<T>, found_inf: Option<T>
    ) {
        Tensor::f_internal_fused_sgd_(self_, grads, momentum_buffer_list, weight_decay, momentum, lr, dampening, nesterov, maximize, is_first_step, grad_scale, found_inf).unwrap()
    }

    pub fn internal_fused_sgd_tensor_lr_<T: Borrow<Tensor>>(
        self_: &[T], grads: &[T], momentum_buffer_list: &[T], weight_decay: f64, momentum: f64, lr: &Tensor, dampening: f64, nesterov: bool, maximize: bool, is_first_step: bool, grad_scale: Option<T>, found_inf: Option<T>
    ) {
        Tensor::f_internal_fused_sgd_tensor_lr_(self_, grads, momentum_buffer_list, weight_decay, momentum, lr, dampening, nesterov, maximize, is_first_step, grad_scale, found_inf).unwrap()
    }

    pub fn internal_fused_sgd_tensor_lr_out<T: Borrow<Tensor>>(
        out: &[T], self_: &[T], grads: &[T], momentum_buffer_list: &[T], weight_decay: f64, momentum: f64, lr: &Tensor, dampening: f64, nesterov: bool, maximize: bool, is_first_step: bool, grad_scale: Option<T>, found_inf: Option<T>
    ) {
        Tensor::f_internal_fused_sgd_tensor_lr_out(out, self_, grads, momentum_buffer_list, weight_decay, momentum, lr, dampening, nesterov, maximize, is_first_step, grad_scale, found_inf).unwrap()
    }
